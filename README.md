...
- [Saleor](https://saleor.io) - Headless GraphQL e-commerce platform with language agnostic API ([Source Code](https://github.com/saleor/saleor)) `BSD-3-Clause` `Docker/Python`
